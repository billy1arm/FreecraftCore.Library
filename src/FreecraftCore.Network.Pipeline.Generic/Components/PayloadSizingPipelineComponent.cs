...
namespace FreecraftCore.Network
{
	...
	public class GamePacketSizingPipelineComponent<TNetworkContextBuilderType, TOperationCodeType, THeaderType, TPayloadType> : INetworkInputPipelineAsyncListener<IWireStreamReaderStrategyAsync, TNetworkContextBuilderType, TOperationCodeType, THeaderType, TPayloadType>
		...
		where TPayloadType : IMessageVerifyable
	{
		...
		/// <inheritdoc />
		public async Task<IWireStreamReaderStrategyAsync> RecievePipelineMessageAsync(IWireStreamReaderStrategyAsync input, TNetworkContextBuilderType currentState)
		{
